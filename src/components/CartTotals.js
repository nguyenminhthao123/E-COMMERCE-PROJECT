...
const CartTotals = () => {
  ...
  const {myUser,loginWithRedirect ,isCheckout}=useUserContext()
  return <Wrapper>
    <div>
      <article>
      ...
      { isCheckout?myUser? <Link to='/checkout' className='btn'>PROCEED TO CHECKOUT</Link>:<button onClick={loginWithRedirect}  className='btn'>Login</button>:null}
